export const exams = [
  ...
  {
    id: 16,
    exam: "hemograma completo automatizada",
    sample: "sangre total",
  ...
  {
    id: 18,
    exam: "examen completo de orina(eco)",
  ...
  {
    id: 29,
    exam: "	BIOPSIA PIEZA OPERATORIA <= 1 MM. (L7)",
    sample: "BIOPSIA",
    method: "MICROSCOPIA / MANUAL",
    price: 65,
    tube: "MEDIO CON FORMOL",
    preanalitic: "LA MUESTRA DEBE COLOCARSE INMEDIATAMENTE EN UN CONTENEDOR CON FORMOL AL 10% DE TAL MANERA QUE ESTA CUBRA TODA LA MUESTRA Y CERRAR HERMETICAMENTE.NO DEBE SER MAYOR A 5MM, OBLIGATORIO: ORDEN MEDICA CON DETALLE DE ZONA + FIRMA Y SELLO",
    time: 1,
    quantity: 1
  },
  {
  ...
  {
    id: 54,
    exam: "recuento de plaquetas en lamina",
    sample: "sangre total con edta",
    method: "microscopia/manual",
    price: 8,
    tube: "tapa lila mas lamina",
  ...
  },
  {
    ...
    preanalitic:
      "SE REQUIERE DE 3 A 5 DÍAS DE ABSTINENCIA. SE RECEPCIONAN LUNES A SÁBADO DE 7 AM A 11 AM. EN CASO DE FERIADO SE RECIBE UN DÍA ANTES. INDICAR FECHA DE VASECTOMÍA SI CORRESPONDE.",
    time: 2,
    quantity: 1
  },
  {
  ...
  {
    id: 75,
    exam: "CHLAMYDIA TRACHOMATIS IGG-IGM-LIMA",
    sample: "suero",
    method: "elisa",
    price: 150,
    tube: "tapa rojo ó amarillo",
  ...
  {
    id: 79,
    exam: "tiempo de protrombina(tp) más inr",
    sample: "plasma/citrato",
    method: "coagulometria",
    price: 10,
    tube: "tapa celeste",
  ...
  {
    id: 81,
    exam: "retraccion de coagulo",
    sample: "sangre total",
    method: "optico-mecanico/manual",
    price: 8,
    tube: "tubo sin aditivo",
    preanalitic: "no requiere preparacion previa. MUESTRA: MÍNIMO 3.0 ML DE SANGRE TOTAL (SIN NINGÚN ADITIVO), TRANSPORTAR DE INMEDIATO AL LABORATORIO PARA EL PRONTO PROCESO.",
    time: 1,
    quantity: 1
  },
  {
  ...
  {
    id: 104,
    exam: "urocultivo más antibiograma",
    sample: "orina simple",
  ...
  },
  {
    ...
    price: 5,
    tube: "tubo lila",
    preanalitic: "no requiere preparacion previa",
    time: 1,
    quantity: 1
  },
  {
  ...
  {
    id: 140,
    exam: "ENA - PERFIL AUTOINMUNE",
    sample: "suero",
    method: "---",
    price: 300,
    tube: "tapa rojo ó amarillo",
    preanalitic: "SE RECOMIENDA AYUNO DE 8 HORAS. PERFIL INCLUYE: NRNP/SM, SM, SS-A, SS-B, SCL70, JO-1, DNADS, HISTONAS, PROTEINA P-RIBOSOMAL, M2, NUCLEOSOMAS. PM-SCL, CENTROMERO.",
    time: "6 a 7",
    quantity: 1
  },
  {
    id: 141,
    exam: "cloro serico (cl)",
    sample: "suero",
    method: "colorimetrico",
    price: 15,
    tube: "tubo rojo / amarillo",
